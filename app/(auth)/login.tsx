  ...
  return (
    <View className="flex-1 flex-col items-center justify-around m-5">
      ...
      <TouchableOpacity
        ...
        className="p-5 rounded-lg bg-[#0D7377] shadow-xl flex flex-row gap-2 items-center justify-around w-[80%] m-5"
      >
        ...
        <View className="bg-white bg-blue- relative rounded-xl size-16 flex items-center justify-center">
          <FontAwesome name="google-plus-square" size={55} color="black" />
        </View>
      </TouchableOpacity>
    </View>
  );
